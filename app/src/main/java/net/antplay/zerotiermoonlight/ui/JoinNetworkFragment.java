...
import net.antplay.zerotiermoonlight.model.DnsServerDao;
...
import net.antplay.zerotiermoonlight.util.NetworkIdUtils;
        ...
        this.mJoinButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    DaoSession daoSession = ((ZeroTierMoonlightApplication) JoinNetworkFragment.this.getActivity().getApplication()).getDaoSession();
